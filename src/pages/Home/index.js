...
export default function Home() {
    ...
    return (
        <div className="select-none">
            <br />
            <div id="toast-warning" className={"m-[auto] flex items-center p-4 w-full max-w-[32rem] text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" + (show ? "" : " hidden")} role="alert">
                ...
                <div className="ml-3 text-sm font-normal">本網站已移至 kd1.haco.tw，本網站將於10/31移除&emsp;&emsp;&emsp;<a className="text-blue-200" href='https://kd1.haco.tw'>點擊前往</a></div>
