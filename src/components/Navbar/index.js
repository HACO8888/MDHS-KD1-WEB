            ...
            <nav className="bg-gray-800 px-4 py-3">
                <div className="flex justify-between item-center">
                    ...
                    <div className="hidden md:flex gap-2">
                        <a href="/" className="text-white px-5 py-3 rounded-md hover:bg-white/5">{ /* bg-gray-900 text-white px-5 py-3 rounded-md */}
                            首頁
                        </a>
                        <a href="/course" className="text-white px-5 py-3 rounded-md hover:bg-white/5">
                            班級課表
                        </a>
                        <a href="/people" className="text-white px-5 py-3 rounded-md hover:bg-white/5">
                            人物趣事
                        </a>
                        <a href="/note" className="text-white px-5 py-3 rounded-md hover:bg-white/5">
                            班級記事
                        </a>
                        <a href="/test" className="text-white px-5 py-3 rounded-md hover:bg-white/5">
                            測試頁面
                        </a>
                    </div>
                ...
                <div className={(navbarOpen ? "" : " hidden")}>
                    <div className="flex flex-col gap-1 py-3">
                        <a href="/" className="text-gray-300 hover:bg-white/5 px-3 py-2 rounded-md md:py-1">
                            首頁
                        </a>
                        <a href="/course" className="text-gray-300 hover:bg-white/5 px-3 py-2 rounded-md">
                            班級課表
                        </a>
                        <a href="/people" className="text-gray-300 hover:bg-white/5 px-3 py-2 rounded-md">
                            人物趣事
                        </a>
                        <a href="/note" className="text-gray-300 hover:bg-white/5 px-3 py-2 rounded-md">
                            班級記事
                        </a>
                        <a href="/test" className="text-gray-300 hover:bg-white/5 px-3 py-2 rounded-md">
                            測試頁面
                        </a>
                    </div>
                </div>
