                ...
                <div className="flex justify-between item-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div>
                            ...
                            <button className={"items-center text-white bg-indigo-600 hover:bg-indigo-700 font-medium rounded-lg text-sm px-4 py-3 text-center flex m-[auto]" + (cookies.get('discord') ? "" : " hidden")} type="button" onClick={() => setLoginMenu(!loginMenu)}>
                            ...
                            <div className={"m-[auto] absolute mt-[5px] z-10 w-[auto] md:w-40 bg-indigo-500 rounded-lg" + (loginMenu ? "" : " hidden")}>
